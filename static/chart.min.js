...
function GetUrlPath(){urlPath=window.location.pathname.split(".")[0].substring(1).split("/")[1];if(urlPath=="hum"){return"humid"}else{return"temperature"}}
function GetUrlParameter(){idx=window.location.href.indexOf("?");if(idx<0)return"";return window.location.href.substring(idx+1)}
function GetChartXml(){console.log(urlParameter);switch(urlParameter){case"1h":case"3h":case"48h":case"1week":case"1month":case"3month":case"1year":return"data/"+urlPath+"/" + urlParameter}return"data/"+urlPath+"/24h"}
...
function GetChartTitle(){var e="Temperatures";if(urlPath=="hum"){e="Humidity"}switch(urlParameter){case"1h":return e+" of the last hour";case"3h":return e+" of the last 3 hours";case"48h":return e+" of the last 48 hours";case"1w":return e+" of the last week";case"1month":return e+" of the last month";case"3m":return e+" of the last 3 month";case"1y":return e+" of the last year"}return e+" of the last 24 hours"}
urlPath=GetUrlPath();
function GetUrlPath() {
	var urlPath;
